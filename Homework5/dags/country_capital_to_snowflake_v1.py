...
def validate_records(records):
    ...
    if len(countries) != len(unique_countries):
        duplicates = len(countries) - len(unique_countries)
        print(f"Warning: Found {duplicates} duplicate countries.")
    else:
...
with DAG(
    ...
    validated_lines = validate_records(lines)
